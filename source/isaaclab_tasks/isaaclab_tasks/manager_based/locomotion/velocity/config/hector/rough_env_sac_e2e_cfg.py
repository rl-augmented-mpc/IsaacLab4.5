...
from isaaclab_assets.robots.hector import HECTOR_E2E_CFG


@configclass
class HECTORRLRoughEnvBlindLocomotionSACCfg(LocomotionVelocityRoughEnvCfg):
    scene: HECTORBlindLocomotionSceneCfg = HECTORBlindLocomotionSceneCfg(num_envs=4096, env_spacing=2.5)
    observations: HECTORRLBlindLocomotionObservationsCfg = HECTORRLBlindLocomotionObservationsCfg()
    actions: HECTORRLBlindLocomotionActionsCfg = HECTORRLBlindLocomotionActionsCfg()
    rewards: HECTORRLBlindLocomotionRewardsCfg = HECTORRLBlindLocomotionRewardsCfg()
    ...
    def __post_init__(self):
        ...
        self.scene.robot = HECTOR_E2E_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.terminations.base_contact.params["sensor_cfg"].body_names = ["trunk", ".*_hip*", ".*_thigh", ".*_calf"]
        # self.terminations.bad_orientation.params["limit_angle"] = math.pi
        self.terminations.base_too_low.params["minimum_height"] = 0.3
...
@configclass
class HECTORRLRoughEnvBlindLocomotionSACCfgPLAY(HECTORRLRoughEnvBlindLocomotionSACCfg):
